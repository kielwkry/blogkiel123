...
<head>
    ...
    <title>Login : McCormick Financial Advisors</title>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div class="col-6">
                                        <p class="small text-right mt-1"><a href="forgot-password.php">Forgot Password ?</a></p>
                                    </div>
                                    <div class="col-12">
                                        <a href="dashboard.php" class="r-btn r-btn-primary btn-block ft-uppercase">
                                            <i class="bi bi-box-arrow-in-right ft-sm mr-2"></i> Login
                                        </a>
                                     </div>
                                    <div class="col-12">
